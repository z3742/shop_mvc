...
<body>
    ...
    <div class="main-layout main-content">
        <div class="sidebar-left">
            <h3 class="sidebar-title">🗺️ 商城导航</h3>
            ...
            <h3 class="sidebar-title" style="margin-top:20px;">🎁 新用户专享</h3>
            <ul class="sidebar-list">
            ...
            <h3 class="sidebar-title" style="margin-top:20px;">📋 注册须知</h3>
            <ul class="sidebar-list">
        ...
        <div class="content-middle">
            <div class="form-wrap">
                ...
                <div class="form-item">
                    <button class="form-btn" id="register-btn">完成注册</button>
                </div>
        ...
        <div class="sidebar-right">
            <h3 class="sidebar-title">🔥 当下热卖</h3>
            <ul class="sidebar-list">
            ...
            <h3 class="sidebar-title" style="margin-top:20px;">🎟️ 优惠券专区</h3>
            <ul class="sidebar-list">
                <li><a href="#">大额满减优惠券</a></li>
                <li><a href="#">品类专属优惠券</a></li>
            </ul>

            <h3 class="sidebar-title" style="margin-top:20px;">🆘 帮助支持</h3>
            <ul class="sidebar-list">
                <li><a href="<?php echo APP_BASE ?>/index/help">帮助中心</a></li>
                <li><a href="#">在线客服</a></li>
            </ul>
